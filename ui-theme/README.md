...
A library for working with UI theme types.
...
As time has passed, some of UI Theme's dependencies could have released versions with a higher Rust requirement.
...
Discussion of UI Theme development happens in the [Linebender Zulip](https://xi.zulipchat.com/), specifically the [#general channel](https://xi.zulipchat.com/#narrow/channel/147921-general).
